...
**Audience**: Users and developers getting started with the CSRRS Sylvester solver
...
Add CSRRS to your `Cargo.toml`:

```toml
[dependencies]
csrrs = "0.1"  # Check for latest version
faer = "0.19"
```
...
```rust
use csrrs::sylvester::{solve_discrete, Sign};
use faer::prelude::*;
...
```rust
use csrrs::sylvester::{solve_continuous, SylvesterError};
...
```rust
use csrrs::sylvester::{solve_continuous, compute_residual, EquationType};
...
```rust
use csrrs::sylvester::{solve_continuous_schur};
...
- **Documentation**: https://docs.rs/csrrs
- **Repository**: https://github.com/yourusername/csrrs
- **Issues**: https://github.com/yourusername/csrrs/issues
