...
**Rivrs vs SPRAL (threads=1) — 65 matrices:**
...
The modern variants (MA57/86/97) require a license we don't have, and the Archive version (MA27, Duff & Reid, 1982) is algorithmically two generations behind SPRAL and MUMPS — it uses minimum degree ordering instead of nested dissection and lacks BLAS-3 supernodal operations.

For IPOPT users, the relevant comparisons are SPRAL (modern, same algorithm family) and MUMPS (widely-used default). MA27 adds no useful data points.  The SuiteSparse collection was run once to establish a baseline, but the MA27 comparison and build script was then removed:

```
MA27 benchmark: 65 matrices
BenElechi/BenElechi1                  245874 fac=6.203s be=1.1e-18
Koutsovasilis/F2                       71505 fac=1.751s be=1.9e-18
PARSEC/H2O                             67024 fac=2351.122s be=2.8e-17
PARSEC/Si10H16                         17077 fac=83.447s be=9.8e-17
PARSEC/Si5H12                          19896 fac=157.184s be=3.5e-17
PARSEC/SiNa                             5743 fac=2.341s be=7.3e-17
Newman/astro-ph                        16706 fac=2.870s be=3.5e-20
Boeing/bcsstk39                        46772 fac=0.393s be=4.8e-18
GHS_indef/bloweybq                     10001 fac=0.001s be=4.3e-17
GHS_indef/copter2                      55476 fac=2.082s be=1.4e-15
Boeing/crystk02                        13965 fac=0.456s be=4.6e-18
Boeing/crystk03                        24696 fac=1.851s be=3.8e-18
GHS_indef/dawson5                      51537 fac=0.208s be=2.8e-16
GHS_indef/dixmaanl                     60000 fac=0.007s be=1.2e-18
Oberwolfach/filter3D                  106437 fac=2.897s be=1.9e-18
Oberwolfach/gas_sensor                 66917 fac=39.447s be=5.9e-18
GHS_indef/helm3d01                     32226 fac=0.955s be=2.0e-15
GHS_indef/linverse                     11999 fac=0.001s be=2.7e-18
INPRO/msdoor                          415863 fac=3.517s be=9.9e-19
ND/nd3k                                 9000 fac=7.999s be=1.8e-17
Boeing/pwtk                           217918 fac=8.764s be=8.2e-19
Cunningham/qa8fk                       66127 fac=13.758s be=4.6e-18
Oberwolfach/rail_79841                 79841 fac=0.040s be=5.1e-19
```
